...
//        }
    ...
    public void ensureExistence(File destination) throws FileNotFoundException {
        // if the directory exists, make sure it is a directory
        File dir = destination.getAbsoluteFile().getParentFile();
        if ( dir.exists() && !dir.isDirectory() ) {
            throw new FileNotFoundException("The path: " + dir.getAbsolutePath() + " exists, but is not a directory");
            ...
            if ( !dir.mkdirs() ) {
                ...
                throw new FileNotFoundException( "unable to create directory: " + dir.getAbsolutePath() );
            }
        }
    }
